...
1. 🏢 A company sets up an **AI hiring agent** for a role in minutes
2. 💬 Candidate enters the **interview room** — no CV needed, just chat
3. 🎯 The AI agent gives **3 progressive, role-specific challenges**
4. 📊 Claude API **evaluates and scores** across Relevance, Creativity & Depth
5. ⛓ Score is **minted as an NFT** on the Polygon blockchain
6. 🏆 Companies browse a **verified leaderboard** and reach out directly
...
- [x] AI interview agent with Claude API
- [x] Real-time scoring engine
- [x] Polygon NFT minting (testnet)
- [x] Candidate leaderboard
